...
slug: trying-to-make-playlists-flow-better
...
featured: false
draft: false
cover: /covers/trying-to-make-playlists-flow-better.png
---
...
<Figure src="/writing/trying-to-make-playlists-flow-better/CompleteGraph.png" alt="Complete graph with songs as nodes and similarity-weighted edges connecting every pair of songs" width={300} />
